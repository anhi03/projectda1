...
public class Hoadon {
    ...
    public Object[]addtorow(){
        return new Object[]{
            this.getId(), this.getMaHD(), this.getTenkh(), 
            this.getTennv(), 
            this.getTongtiensauKM(), 
            this.getNgayThanhToan(), 
            this.getTrangthai() ? "đã thanh toán":"chưa thanh toán"
        };
    }

    public Object[]addtoform(){
        return new Object[]{
            this.getId(), this.getMaHD(), this.getTenkh(), 
            this.getTennv(), 
            this.getMavoucher(),
            this.getTongtienbandau(), this.getTongkhuyenmai(), 
            this.getTongtiensauKM(), 
            this.getNgayThanhToan(), this.getTrangthai()
        };
    }
}
